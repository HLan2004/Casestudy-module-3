...
<div class="container mx-auto px-4 py-10">
  ...
  <div class="bg-white dark:bg-gray-800 shadow-md rounded-xl p-8">
    <form method="post" action="/blog/create" class="space-y-6">
      ...
      <div>
        <button type="submit" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 rounded-lg transition transform hover:scale-105 shadow">
